...
const defaultData = {
  users: [
    ...
    { id: 'dealer@greenvoltes.in', email: 'dealer@greenvoltes.in', name: 'Malabar Solar Agencies', role: 'Dealer', passwordHash: hashPassword('dealer123', defaultSalt), salt: defaultSalt },
  ...
  dealers: [
    {
      id: 'D001',
      name: 'Malabar Solar Agencies',
      contactPerson: 'Kabeer Ahmed',
      mobile: '9562778899',
      email: 'kabeer@malabarsolar.com',
      district: 'Kozhikode',
      state: 'Kerala',
      status: 'Approved',
    ...
    {
      id: 'D002',
      name: 'Cochin Tech & Solar',
      contactPerson: 'Sandeep Varma',
      mobile: '9744112233',
      email: 'sandeep@cochintech.in',
      district: 'Ernakulam',
      state: 'Kerala',
      status: 'Approved',
    ...
    {
      id: 'D003',
      name: 'Travancore Green Energy',
      contactPerson: 'Radhakrishnan P.',
      mobile: '9446889900',
      email: 'radha@travancoresolar.com',
      district: 'Kollam',
      state: 'Kerala',
