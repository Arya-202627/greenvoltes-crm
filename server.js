...
const defaultData = {
  users: [
    ...
    { id: 'ruksana', email: 'ruksana', name: 'Ruksana', role: 'Dealer', dealerId: 'D001', passwordHash: hashPassword('ruksana', defaultSalt), salt: defaultSalt },
    { id: 'yadu', email: 'yadu', name: 'Yadu', role: 'Dealer', dealerId: 'D002', passwordHash: hashPassword('yadu', defaultSalt), salt: defaultSalt },
    { id: 'vyshak', email: 'vyshak', name: 'Vyshak', role: 'Dealer', dealerId: 'D003', passwordHash: hashPassword('vyshak', defaultSalt), salt: defaultSalt },
    { id: 'rinku', email: 'rinku', name: 'Rinku', role: 'Dealer', dealerId: 'D004', passwordHash: hashPassword('rinku', defaultSalt), salt: defaultSalt },
    { id: 'aswin', email: 'aswin', name: 'Aswin', role: 'Dealer', dealerId: 'D005', passwordHash: hashPassword('aswin', defaultSalt), salt: defaultSalt },
  ...
  dealers: [
    {
      id: 'D001',
      name: 'Dealer 1 (Ruksana)',
      contactPerson: 'Ruksana',
      mobile: '9000000001',
      email: 'ruksana',
      district: 'Kozhikode',
      state: 'Kerala',
      status: 'Approved',
      assignedTerritory: 'North Kerala',
      commissionRate: 5,
      earnings: 45000,
      paidAmount: 30000,
      salesCount: 8
    },
    {
      ...
      state: 'Kerala',
      status: 'Approved',
      assignedTerritory: 'Central Kerala',
      commissionRate: 6,
      earnings: 15000,
      paidAmount: 15000,
      salesCount: 2
    },
    {
      ...
      state: 'Kerala',
      status: 'Approved',
      assignedTerritory: 'South Kerala',
      commissionRate: 5,
      earnings: 0,
      paidAmount: 0,
      salesCount: 0
