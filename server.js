...
const defaultData = {
  users: [
    ...
    { id: 'dinesh', email: 'dinesh', name: 'Dinesh', role: 'Employee', employeeId: 'EMP001', dealerId: 'D001', passwordHash: hashPassword('8714889721', defaultSalt), salt: defaultSalt },
    { id: 'ganesh', email: 'ganesh', name: 'Ganesh', role: 'Employee', employeeId: 'EMP002', dealerId: 'D002', passwordHash: hashPassword('9633223787', defaultSalt), salt: defaultSalt },
    { id: 'ruksana', email: 'ruksana', name: 'Ruksana C R.', role: 'Employee', employeeId: 'EMP003', dealerId: 'D003', passwordHash: hashPassword('8129900484', defaultSalt), salt: defaultSalt },
    { id: 'yadu', email: 'yadu', name: 'Yadhu krishnan S', role: 'Employee', employeeId: 'EMP004', dealerId: 'D004', passwordHash: hashPassword('8129920094', defaultSalt), salt: defaultSalt },
    { id: 'vyshak', email: 'vyshak', name: 'Vyshak', role: 'Employee', employeeId: 'EMP005', dealerId: 'D005', passwordHash: hashPassword('7994005973', defaultSalt), salt: defaultSalt },
    { id: 'kannan', email: 'kannan', name: 'Kannan K S', role: 'Employee', employeeId: 'EMP006', dealerId: 'D006', passwordHash: hashPassword('9947762396', defaultSalt), salt: defaultSalt },
    { id: 'rinku', email: 'rinku', name: 'Rinku Mathew', role: 'Employee', employeeId: 'EMP007', dealerId: 'D007', passwordHash: hashPassword('7907347100', defaultSalt), salt: defaultSalt },
    { id: 'aswin', email: 'aswin', name: 'Aswin', role: 'Employee', employeeId: 'EMP008', dealerId: 'D008', passwordHash: hashPassword('8590544311', defaultSalt), salt: defaultSalt },
    { id: 'anandu', email: 'anandu', name: 'Anandu L', role: 'Employee', employeeId: 'EMP009', dealerId: 'D009', passwordHash: hashPassword('9633591854', defaultSalt), salt: defaultSalt },
