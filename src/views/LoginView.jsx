...
export default function LoginView({ onLoginSuccess }) {
  ...
  const demoUsers = [
    ...
    { email: 'GV001', pass: 'GV001dinesh', role: 'Employee (Dinesh)' },
    { email: 'GV002', pass: 'GV002ganesh', role: 'Employee (Ganesh)' },
    { email: 'GV003', pass: 'GV003ruksana', role: 'Employee (Ruksana C R.)' },
    { email: 'GV004', pass: 'GV004yadu', role: 'Employee (Yadhu S)' },
    { email: 'GV005', pass: 'GV005vyshak', role: 'Employee (Vyshak)' },
    { email: 'GV006', pass: 'GV006kannan', role: 'Employee (Kannan K S)' },
    { email: 'GV007', pass: 'GV007rinku', role: 'Employee (Rinku Mathew)' },
    { email: 'GV008', pass: 'GV008aswin', role: 'Employee (Aswin)' },
    { email: 'GV009', pass: 'GV009anandu', role: 'Employee (Anandu L)' },
